<x-app-layout>
    ...
    <div class="flex flex-wrap justify-between items-center gap-4 mb-6">
        <div class="flex flex-col gap-1">
            <h1 class="text-3xl font-black leading-tight tracking-tight text-gray-900">Modifier le Client</h1>
            <p class="text-base font-normal text-gray-500">Modifiez les informations du client.</p>
        </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <form action="{{ route('clients.update', $client) }}" method="POST" class="flex flex-col gap-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex flex-col gap-2">
                ...
                <textarea id="address" 
                          name="address" 
                          rows="3"
                          class="form-textarea rounded-lg border border-gray-300 bg-gray-50 px-4 py-3 text-gray-900 focus:border-blue-600 focus:ring-2 focus:ring-blue-500/50">{{ old('address', $client->address) }}</textarea>
            </div>
