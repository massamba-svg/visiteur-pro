            ...
            <div class="layout-content-container flex flex-col w-full bg-white dark:bg-background-dark dark:border dark:border-white/10 shadow-sm rounded-xl p-6 sm:p-8">
                ...
                <div class="flex flex-col gap-4 px-4 py-3">
                    <label class="flex flex-col w-full">
                        <p class="text-[#0d121b] dark:text-white/80 text-base font-medium leading-normal pb-2">Nom complet</p>
                        <input class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#0d121b] dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-[#cfd7e7] dark:border-white/20 bg-[#f8f9fc] dark:bg-white/5 focus:border-primary h-14 placeholder:text-[#4c669a] dark:placeholder:text-white/40 p-[15px] text-base font-normal leading-normal" placeholder="Entrez votre nom complet" value="" />
                    </label>
                    <label class="flex flex-col w-full">
                        <p class="text-[#0d121b] dark:text-white/80 text-base font-medium leading-normal pb-2">Adresse e-mail</p>
                        <input class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#0d121b] dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-[#cfd7e7] dark:border-white/20 bg-[#f8f9fc] dark:bg-white/5 focus:border-primary h-14 placeholder:text-[#4c669a] dark:placeholder:text-white/40 p-[15px] text-base font-normal leading-normal" placeholder="votre.email@exemple.com" type="email" value="" />
                    </label>
                    <label class="flex flex-col w-full">
                        ...
                        <div class="flex w-full flex-1 items-stretch">
                            <input class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-l-lg text-[#0d121b] dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-[#cfd7e7] dark:border-white/20 bg-[#f8f9fc] dark:bg-white/5 focus:border-primary h-14 placeholder:text-[#4c669a] dark:placeholder:text-white/40 p-[15px] border-r-0 text-base font-normal leading-normal" placeholder="Choisissez un mot de passe" type="password" value="" />
                    ...
                    <label class="flex flex-col w-full">
                        <p class="text-[#0d121b] dark:text-white/80 text-base font-medium leading-normal pb-2">Confirmer le mot de passe</p>
                        <input class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#0d121b] dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-[#cfd7e7] dark:border-white/20 bg-[#f8f9fc] dark:bg-white/5 focus:border-primary h-14 placeholder:text-[#4c669a] dark:placeholder:text-white/40 p-[15px] text-base font-normal leading-normal" placeholder="Retapez votre mot de passe" type="password" value="" />
                    </label>
                </div>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-2 px-4 pt-4 text-sm text-center">
                    <span class="text-[#4c669a] dark:text-white/60">Vous avez déjà un compte ?</span>
                    <a class="text-primary hover:underline dark:text-primary/90" href="{{ route('login') }}">Se connecter</a>
                </div>
            </div>
