<x-app-layout>
    ...
    <div class="flex flex-wrap justify-between items-center gap-4 mb-6">
        <div class="flex flex-col gap-1">
            <h1 class="text-3xl font-black leading-tight tracking-tight text-gray-900">Nouvelle Visite</h1>
            <p class="text-base font-normal text-gray-500">Enregistrez une nouvelle visite client.</p>
        </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <form action="{{ route('visits.store') }}" method="POST" class="flex flex-col gap-6">
            @csrf
