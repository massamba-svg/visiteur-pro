<x-app-layout>
    ...
    <div class="flex flex-wrap justify-between items-center gap-4 mb-6">
        <div class="flex flex-col gap-1">
            <h1 class="text-3xl font-black leading-tight tracking-tight text-gray-900">Nouveau Rôle</h1>
            <p class="text-base font-normal text-gray-500">Créez un nouveau rôle utilisateur.</p>
        </div>
        ...
        <form action="{{ route('roles.store') }}" method="POST" class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-2">
                ...
                <textarea id="description" 
                          ...
                          placeholder="Décrivez les permissions de ce rôle...">{{ old('description') }}</textarea>
                @error('description')
                    <p class="text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
